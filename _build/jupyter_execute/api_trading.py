...
# 
# ```{figure} image/api_trading/hts_down.png
# ---
# name: hts_down
# ---
# 온라인 거래시스템
...
# 1. 먼저 국내 대형주 10종목(모델 포트폴리오)의 티커를 데이터프레임(mp) 형태로 만든 후, 보유 종목과 aum을 불러온다.
...
# 
# 먼저 대형주 5주 및 '멀티팩터 포트폴리오' 구성을 통해 나온 종목들 중 5종목을 매수해보자.
